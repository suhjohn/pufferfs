...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("railway");
			params.setVersion("0.6.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3RlcnJhZm9ybS1jb21tdW5pdHktcHJvdmlkZXJzL3JhaWx3YXkiLCJ2ZXJzaW9uIjoiMC42LjIifX0="), c => c.charCodeAt(0)));

			const req = new resproto.RegisterPackageRequest();
			req.setName("terraform-provider");
			req.setVersion("1.1.3");
			req.setDownloadUrl("");
