...
set_config_if_present pufferfs:embeddingRequestsPerMinute "${PUFFERFS_EMBEDDING_REQUESTS_PER_MINUTE:-1024}"
set_config_if_present pufferfs:embeddingTokensPerMinute "${PUFFERFS_EMBEDDING_TOKENS_PER_MINUTE:-2000000}"
set_config_if_present pufferfs:searchConcurrency "${PUFFERFS_SEARCH_CONCURRENCY:-32}"
set_config_if_present pufferfs:searchTenantConcurrency "${PUFFERFS_SEARCH_TENANT_CONCURRENCY:-16}"
