...
func indexedChunkFromModal(rootID, fileHash string, chunk map[string]any) indexedChunk {
	return indexedChunk{
		ID:          strVal(chunk, "id"),
...
func indexedChunkFromExisting(rootID, filePath, fileHash string, chunkIndex int, row map[string]any) indexedChunk {
	return indexedChunk{
		ID:          "",
