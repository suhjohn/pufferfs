...
for module in ("aws_clients", "source_io", "extraction", "file_runtime", "worker_metrics", "nomic_model", "embedding_artifacts", "index_mutations", "index_routing", "index_client", "index_prepare", "index_publish", "index_worker", "role_auth"):
